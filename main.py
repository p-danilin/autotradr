...
class Main:
    ...
    def load_data(self, ticker, start_date, end_date, interval='1d'):
    ...
    def main(self):
        data = self.load_data('AAPL', '2022-01-01', '2023-12-31')
        ...
        print(f"\nFinal Results with Best Parameters {best_params}:")
        print(f"Final Portfolio Value: {results['Final Portfolio Value']}")
        
        # Print individual transactions for the winning strategy
        print(f"\nTransactions for the winning strategy {best_params}:")
